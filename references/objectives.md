...
cluster. In the calibration case a candidate scored 0% on 5, 10, 11 and 29 while
the coach's own items had reported the same ground as mastered — because the
coach's option lists never once named `PreToolUse` or settings permissions.
